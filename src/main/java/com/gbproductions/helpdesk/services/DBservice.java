...
public class DBservice {
    ...
    public void instanciaDB() {
        ...
        Tecnico tec1 = new Tecnico(null, "Gilberto da Silva Espinoso", "235.590.410-31", "gilberto.espinoso@gmail.com", encoder.encode("123"));
        tec1.addPerfil(Perfil.ADMIN);
        Tecnico tec2 = new Tecnico(null, "Marlon Rocha Sobrinho", "081.273.280-49", "marlonsobrinho@email.com", encoder.encode("123"));
        Tecnico tec3 = new Tecnico(null, "Richard Kleytson da Silva", "017.471.050-07", "pitbull@gmail.com", encoder.encode("123"));
        Tecnico tec4 = new Tecnico(null, "Vigoroso Sobrinho Babul", "741.309.520-30", "vigorosogg@gmail.com", encoder.encode("123"));
        Tecnico tec5 = new Tecnico(null, "Renan Gonçalvez Neves", "111.082.050-03", "renantd2@gmail.com", encoder.encode("123"));
        Tecnico tec6 = new Tecnico(null, "Rafael da Silva Rodrigues", "756.164.100-12", "rafealboladao@gmail.com", encoder.encode("123"));

        //ADICIONANDO CLIENTES PARA TESTES
        Cliente clie1 = new Cliente(null, "João Mendonça Gonçalves", "932.810.370-38", "joaomendonca@hotmail.com", encoder.encode("123"));
        Cliente clie2 = new Cliente(null, "Engie - Brasil", "439.552.340-45", "contato@engie.com", encoder.encode("123"));
